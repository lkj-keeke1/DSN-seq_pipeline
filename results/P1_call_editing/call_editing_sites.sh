...
## mapping parameters
clean_R1=$3  # clean R1 fastq file, absolute path
clean_R2=$4  # clean R2 fastq file, absolute path
hisat_ref=$5      # hisat2 reference, absolute path

hisat2_thread=4   # threads for hisat2 mapping step
samtools_thread=4 # threads for samtools view and sor


## Call editing parameters
ref_genome=$6              # multi-FASTA file, absolute path
length_table=$7                  # fasta sequences length table, absolute path
